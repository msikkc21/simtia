...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 p-0">
            <div id="tt-reference-acd" class="easyui-tabs" style="height:{{ $TabHeight }}"
                data-options="plain:true,narrow:true,tabPosition:'left',headerWidth:200">
                <div title="Tingkat" class="p-1">
                    <div class="container-fluid mb-2">
                        <div class="row">
                            <div class="col-12 p-0 text-right">
                                <a class="easyui-linkbutton top-btn" data-options="iconCls:'ms-Icon ms-Icon--PDF'"
                                    onclick="exportAcademicRef('tb-ref-grade','{{ url('academic/grade/export-') }}','pdf','Tingkat')">Ekspor
                                    PDF</a>
                            </div>
                        </div>
                    </div>
                    <div class="easyui-layout" style="height:{{ $TabContentHeight }};width:{{ $WindowWidth }};">
                        <div data-options="region:'west',split:true,collapsible:true,title:'Daftar'"
                            style="width:300px">
                            <div class="p-1">
                                <table id="tb-ref-grade" class="easyui-datagrid"
                                    style="width:100%;height:{{ $TabGridHeight }}"
                                    data-options="singleSelect:true,method:'post',rownumbers:'true',pagination:'true',pageSize:50,pageList:[10,25,50,75,100]">
                                    <thead>
                                        <tr>
                                            <th
                                                data-options="field:'department_id',width:100,resizeable:true,sortable:true">
                                                Departemen</th>
                                            <th
                                                data-options="field:'grade',width:80,resizeable:true,sortable:true,align:'center'">
                                                Tingkat</th>
                                        </tr>
                                    </thead>
                                </table>
                        ...
                        <div data-options="region:'center'">
                            <div id="menu-act-grade" class="panel-top">
                                <a id="newGrade" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Add'"
                                    onclick="newGrade()">Baru</a>
                                <a id="editGrade" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Edit'"
                                    onclick="editGrade()">Ubah</a>
                                <a id="saveGrade" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Save'"
                                    onclick="saveGrade()">Simpan</a>
                                <a id="clearGrade" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Clear'"
                                    onclick="clearGrade()">Batal</a>
                                <a id="deleteGrade" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Delete'"
                                    onclick="deleteGrade()">Hapus</a>
                            </div>
                            <div class="title">
                                ...
                                <form id="form-grade-main" method="post">
                                    ...
                                    <div class="mb-1">
                                        @if (auth()->user()->getDepartment->is_all != 1)
                                            <input value="{{ auth()->user()->getDepartment->name }}"
                                                class="easyui-textbox" style="width:375px;height:22px;"
                                                data-options="label:'Departemen:',labelWidth:'125px',readonly:true" />
                                            <input type="hidden" name="department_id"
                                                value="{{ auth()->user()->department_id }}" />
                                        @else
                                            <select name="department_id" id="GradeDeptId" class="easyui-combobox"
                                                style="width:375px;height:22px;"
                                                data-options="label:'<b>*</b>Departemen:',labelWidth:'125px',labelPosition:'before',panelHeight:125">
                                    ...
                                    <div class="mb-1">
                                        <input name="grade" id="GradeId" class="easyui-numberspinner"
                                            style="width:200px;height:22px;"
                                            data-options="label:'<b>*</b>Tingkat:',labelWidth:'125px',labelPosition:'before',min:1" />
                                        <span class="mr-2 @if (auth()->user()->getDepartment->is_all != 1) d-none @endif">
                                            <input name="is_all" id="GradeIdAll" class="easyui-checkbox" value="2"
                                                style="height:22px;"
                                                data-options="label:'Semua Departemen',labelWidth:'140px',labelPosition:'after'" />
                                        </span>
                                    </div>
                                    <div class="mb-1">
                                        <input name="remark" class="easyui-textbox" style="width:375px;height:50px;"
                                            data-options="label:'Keterangan:',labelWidth:'125px',labelPosition:'before',multiline:true" />
                                    </div>
                                    <div class="mb-1">
                                        <input name="is_active" class="easyui-checkbox" value="2"
                                            style="height:22px;"
                                            data-options="label:'Non Aktif:',labelWidth:'125px',labelPosition:'before'" />
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div title="Tahun Ajaran" class="p-1">
                    <div class="container-fluid mb-2">
                        <div class="row">
                            <div class="col-12 p-0 text-right">
                                <a class="easyui-linkbutton top-btn" data-options="iconCls:'ms-Icon ms-Icon--PDF'"
                                    onclick="exportAcademicRef('tb-ref-schoolyear','{{ url('academic/school-year/export-') }}','pdf','Tahun Ajaran')">Ekspor
                                    PDF</a>
                            </div>
                        </div>
                    </div>
                    <div class="easyui-layout" style="height:{{ $TabContentHeight }};width:{{ $WindowWidth }};">
                        <div data-options="region:'west',split:true,collapsible:true,title:'Daftar'"
                            style="width:300px">
                            <div class="p-1">
                                <table id="tb-ref-schoolyear" class="easyui-datagrid"
                                    style="width:100%;height:{{ $TabGridHeight }}"
                                    data-options="singleSelect:true,method:'post',rownumbers:'true',pagination:'true',pageSize:50,pageList:[10,25,50,75,100],
                                    ...
                                    <thead>
                                        <tr>
                                            <th
                                                ...
                                                Departemen</th>
                                            <th
                                                data-options="field:'school_year',width:100,resizeable:true,sortable:true">
                                                Tahun Ajaran</th>
                                        </tr>
                                    </thead>
                                </table>
                        ...
                        <div data-options="region:'center'">
                            <div id="menu-act-schoolyear" class="panel-top">
                                <a id="newSchoolYear" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Add'"
                                    onclick="newSchoolYear()">Baru</a>
                                <a id="editSchoolYear" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Edit'"
                                    onclick="editSchoolYear()">Ubah</a>
                                <a id="saveSchoolYear" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Save'"
                                    onclick="saveSchoolYear()">Simpan</a>
                                <a id="clearSchoolYear" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Clear'"
                                    onclick="clearSchoolYear()">Batal</a>
                                <a id="deleteSchoolYear" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Delete'"
                                    onclick="deleteSchoolYear()">Hapus</a>
                            </div>
                            <div class="title">
                                <h6><span id="mark-schoolyear"></span>Tahun Ajaran: <span
                                        id="title-schoolyear"></span></h6>
                            </div>
                            <div class="p-3" id="page-schoolyear">
                                <form id="form-schoolyear-main" method="post">
                                    ...
                                    <div class="mb-1">
                                        <select name="department_id" id="SchoolYearDeptId" class="easyui-combobox"
                                            style="width:375px;height:22px;"
                                            data-options="label:'<b>*</b>Departemen:',labelWidth:'125px',labelPosition:'before',panelHeight:125">
                                    ...
                                    <div class="mb-1">
                                        <input name="school_year" id="SchoolYearId" class="easyui-numberspinner"
                                            style="width:200px;height:22px;"
                                            data-options="label:'<b>*</b>Tahun Ajaran:',labelWidth:'125px',labelPosition:'before',min:2020" />
                                    </div>
                                    <div class="mb-1">
                                        <input name="start_date" class="easyui-datebox"
                                            style="width:235px;height:22px;"
                                            data-options="label:'<b>*</b>Tanggal Mulai:',labelWidth:'125px',labelPosition:'before',formatter:dateFormatter,parser:dateParser" />
                                    </div>
                                    <div class="mb-1">
                                        <input name="end_date" class="easyui-datebox"
                                            style="width:235px;height:22px;"
                                            data-options="label:'<b>*</b>Tanggal Akhir:',labelWidth:'125px',labelPosition:'before',formatter:dateFormatter,parser:dateParser" />
                                    </div>
                                    <div class="mb-1">
                                        <input name="remark" class="easyui-textbox" style="width:375px;height:40px;"
                                            data-options="label:'Keterangan:',labelWidth:'125px',labelPosition:'before',multiline:true" />
                                    </div>
                                    <div class="mb-5">
                                        <input name="is_active" class="easyui-checkbox" value="2"
                                ...
                                <p class="well">
                                    ...
                                    Menu ini mengatur tahun ajaran yang ada di departemen sekolah. Setiap pergantian
                                    tahun ajaran, pengguna harus mengubah status aktif tahun ajaran ini.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div title="Semester" class="p-1">
                    <div class="container-fluid mb-2">
                        <div class="row">
                            <div class="col-12 p-0 text-right">
                                <a class="easyui-linkbutton top-btn" data-options="iconCls:'ms-Icon ms-Icon--PDF'"
                                    onclick="exportAcademicRef('tb-ref-semester','{{ url('academic/semester/export-') }}','pdf','Semester')">Ekspor
                                    PDF</a>
                            </div>
                        </div>
                    </div>
                    <div class="easyui-layout" style="height:{{ $TabContentHeight }};width:{{ $WindowWidth }};">
                        <div data-options="region:'west',split:true,collapsible:true,title:'Daftar'"
                            style="width:300px">
                            <div class="p-1">
                                <table id="tb-ref-semester" class="easyui-datagrid"
                                    style="width:100%;height:{{ $TabGridHeight }}"
                                    data-options="singleSelect:true,method:'post',rownumbers:'true',pagination:'true',pageSize:50,pageList:[10,25,50,75,100],
                                            rowStyler:function (index, row) { if (row.is_active === 'Aktif') { return 'font-weight:600' } }">
                                    <thead>
                                        <tr>
                                            <th
                                                ...
                                                Departemen</th>
                                            <th
                                                data-options="field:'semester',width:80,resizeable:true,sortable:true,align:'center'">
                                                Semester</th>
                                        </tr>
                                    </thead>
                                </table>
                        ...
                        <div data-options="region:'center'">
                            <div id="menu-act-semester" class="panel-top">
                                <a id="newSemester" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Add'"
                                    onclick="newSemester()">Baru</a>
                                <a id="editSemester" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Edit'"
                                    onclick="editSemester()">Ubah</a>
                                <a id="saveSemester" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Save'"
                                    onclick="saveSemester()">Simpan</a>
                                <a id="clearSemester" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Clear'"
                                    onclick="clearSemester()">Batal</a>
                                <a id="deleteSemester" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Delete'"
                                    onclick="deleteSemester()">Hapus</a>
                            </div>
                            <div class="title">
                            ...
                            <div class="p-3" id="page-semester">
                                <form id="form-semester-main" method="post">
                                    ...
                                    <div class="mb-1">
                                        @if (auth()->user()->getDepartment->is_all != 1)
                                            ...
                                            <input type="hidden" name="department_id"
                                                value="{{ auth()->user()->department_id }}" />
                                        @else
                                            <select name="department_id" id="SemesterDeptId" class="easyui-combobox"
                                                style="width:375px;height:22px;"
                                                data-options="label:'<b>*</b>Departemen:',labelWidth:'125px',labelPosition:'before',panelHeight:125">
                                                @foreach ($depts as $dept)
                                                    <option value="{{ $dept->id }}">{{ $dept->name }}</option>
                                    ...
                                    <div class="mb-1">
                                        <input name="semester" id="SemesterId" class="easyui-textbox"
                                            style="width:200px;height:22px;"
                                            data-options="label:'<b>*</b>Semester:',labelWidth:'125px',labelPosition:'before'" />
                                        <span class="mr-2 @if (auth()->user()->getDepartment->is_all != 1) d-none @endif">
                                            <input name="is_all" id="SemesterIdAll" class="easyui-checkbox"
                                                value="2" style="height:22px;"
                                                data-options="label:'Semua Departemen',labelWidth:'140px',labelPosition:'after'" />
                                        </span>
                                    </div>
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        <input name="is_active" id="SemesterIsActive" class="easyui-checkbox"
                                            value="2" style="height:22px;"
                                            data-options="label:'Non Aktif:',labelWidth:'125px',labelPosition:'before'" />
                                    </div>
                                    <div class="mb-1" id="SemesterGradeIdDiv">
                                        <select name="grade_id" id="SemesterGradeId" class="easyui-combogrid"
                                            style="width:275px;height:22px;"
                                            data-options="
                                        label:'<b>*</b>Tingkat:',
                                        labelWidth:'125px',
                                        panelWidth: 230,
                                ...
                                <p class="well mt-5">
                                    <label style="font-weight:500">Penting:</label><br />
                                    Menu ini mengatur setiap nama semester yang ada di departemen sekolah. Setiap
                                    pergantian semester, pengguna harus mengubah status aktif semester ini.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div title="Kelas" class="p-1">
                    <div class="container-fluid mb-2">
                        <div class="row">
                            <div class="col-12 p-0 text-right">
                                <a class="easyui-linkbutton top-btn" data-options="iconCls:'ms-Icon ms-Icon--PDF'"
                                    onclick="exportAcademicRef('tb-ref-class','{{ url('academic/class/export-') }}','pdf','Kelas')">Ekspor
                                    PDF</a>
                            </div>
                        </div>
                    </div>
                    <div class="easyui-layout" style="height:{{ $TabContentHeight }};width:{{ $WindowWidth }};">
                        <div data-options="region:'west',split:true,collapsible:true,title:'Daftar'"
                            style="width:300px">
                            <div class="p-1">
                                <table id="tb-ref-class" class="easyui-datagrid"
                                    style="width:100%;height:{{ $TabGridHeight }}"
                                    data-options="singleSelect:true,method:'post',rownumbers:'true',pagination:'true',pageSize:50,pageList:[10,25,50,75,100]">
                                    <thead>
                                        <tr>
                                            @if (auth()->user()->getDepartment->is_all == 1)
                                                <th data-options="field:'department_id',width:100,resizeable:true">
                                                    Departemen</th>
                                            @endif
                                            <th
                                                data-options="field:'schoolyear_id',width:80,resizeable:true,sortable:true,align:'center'">
                                                Thn. Ajaran</th>
                                            <th
                                                data-options="field:'grade_id',width:70,resizeable:true,sortable:true,align:'center'">
                                                Tingkat</th>
                                            <th data-options="field:'class',width:80,resizeable:true,sortable:true">
                                                Kelas</th>
                                            <th data-options="field:'quota',width:100,resizeable:true,sortable:false">
                                                Kapasitas/Terisi</th>
                                        </tr>
                                    </thead>
                                </table>
                        ...
                        <div data-options="region:'center'">
                            <div id="menu-act-class" class="panel-top">
                                <a id="newClass" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Add'"
                                    onclick="newClass()">Baru</a>
                                <a id="editClass" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Edit'"
                                    onclick="editClass()">Ubah</a>
                                <a id="saveClass" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Save'"
                                    onclick="saveClass()">Simpan</a>
                                <a id="clearClass" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Clear'"
                                    onclick="clearClass()">Batal</a>
                                <a id="deleteClass" class="easyui-linkbutton action-btn"
                                    data-options="plain:true,iconCls:'ms-Icon ms-Icon--Delete'"
                                    onclick="deleteClass()">Hapus</a>
                            </div>
                            <div class="title">
                            ...
                            <div class="p-3" id="page-class">
                                <form id="form-class-main" method="post">
                                    ...
                                    <div class="mb-1">
                                        <input id="ClassDeptId" class="easyui-textbox"
                                            style="width:375px;height:22px;"
                                            data-options="label:'Departemen:',labelWidth:'125px',readonly:true" />
                                        <input id="id-class-department" type="hidden" name="department_id"
                                            value="-1" />
                                    </div>
                                    <div class="mb-1">
                                        <select name="grade_id" id="ClassGradeId" class="easyui-combogrid"
                                            style="width:275px;height:22px;"
                                            data-options="
                                        label:'<b>*</b>Tingkat:',
                                        labelWidth:'125px',
                                    ...
                                    ">
                                        ...
                                        <a class="easyui-linkbutton small-btn" onclick="reloadClassGrade()"
                                            style="width:27px;height:22px;"><i
                                                class="ms-Icon ms-Icon--Refresh"></i></a>
                                    </div>
                                    <div class="mb-1">
                                        <select name="schoolyear_id" class="easyui-combobox" id="ClassSchoolYearId"
                                            style="width:275px;height:22px;"
                                            data-options="label:'<b>*</b>Tahun Ajaran:',labelWidth:'125px',panelHeight:78,valueField:'id',textField:'text'">
                                            <option value="">---</option>
                                        </select>
                                    </div>
                                    <div class="mb-1">
                                        <input name="class" id="ClassId" class="easyui-textbox"
                                            style="width:275px;height:22px;"
                                            data-options="label:'<b>*</b>Kelas:',labelWidth:'125px',labelPosition:'before'" />
                                        <span class="mr-2"></span>
                                        <input name="is_copy" id="ClassCopy" class="easyui-checkbox" value="2"
                                            style="height:22px;"
                                            data-options="label:'Salin dari tahun ajaran sebelumnya',labelWidth:'250px',labelPosition:'after'" />
                                    </div>
                                    <div class="mb-1">
                                        <select name="employee_id" id="ClassEmployeeId" class="easyui-combogrid"
                                            style="width:375px;height:22px;"
                                            data-options="
                                    ...
                                    <div class="mb-1">
                                        <input name="capacity" id="ClassCapacity" class="easyui-numberspinner"
                                            style="width:375px;height:22px;"
                                            data-options="label:'<b>*</b>Kapasitas:',labelWidth:'125px',labelPosition:'before',min:1" />
                                    </div>
                                    <div class="mb-1">
                                        <input name="remark" class="easyui-textbox" style="width:375px;height:50px;"
                                            data-options="label:'Keterangan:',labelWidth:'125px',labelPosition:'before',multiline:true" />
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        dgGrade.datagrid({
            ...
            onDblClickRow: function(index, row) {
                if (sessionStorage.formRef_Akademik_Grade == "active") {
                    ...
                    $("#form-grade-main").form("load", "{{ url('academic/grade/show') }}" + "/" +
                        row.id)
                    $("#page-grade").waitMe("hide")
                }
            }
        })
        dgGrade.datagrid("getPager").pagination({
        ...
        dgSchoolYear.datagrid({
            ...
            onDblClickRow: function(index, row) {
                if (sessionStorage.formRef_Akademik_SchoolYear == "active") {
                    ...
                    $("#form-schoolyear-main").form("load",
                        "{{ url('academic/school-year/show') }}" + "/" + row.id)
                    $("#page-schoolyear").waitMe("hide")
                }
            }
        })
        dgSchoolYear.datagrid("getPager").pagination({
            layout: ["list", "first", "prev", "next", "last", "info"]
        })
        ...
        dgSemester.datagrid({
            ...
            onDblClickRow: function(index, row) {
                if (sessionStorage.formRef_Akademik_Semester == "active") {
                    ...
                    $("#form-semester-main").form("load", "{{ url('academic/semester/show') }}" +
                        "/" + row.id)
                    $("#page-semester").waitMe("hide")
                }
            }
        })
        dgSemester.datagrid("getPager").pagination({
            layout: ["list", "first", "prev", "next", "last", "info"]
        })
        ...
        $("#SemesterDeptId").combobox({
            onChange: function(newVal, oldVal) {
                $("#SemesterGradeId").combogrid("grid").datagrid("load", {
                    _token: '{{ csrf_token() }}',
        ...
        dgClass.datagrid({
            ...
            onDblClickRow: function(index, row) {
                if (sessionStorage.formRef_Akademik_Class == "active") {
                    ...
                    $("#form-class-main").form("load", "{{ url('academic/class/show') }}" + "/" +
                        row.id)
                    $("#id-class-department").val(row.id_department)
                    $("#ClassDeptId").textbox("setValue", row.department_id)
                    $("#ClassSchoolYearId").combobox("reload",
                        "{{ url('academic/school-year/combo-box') }}" + "/" + 1 + "?_token=" +
                        "{{ csrf_token() }}").combobox("setValue", row.id_schoolyear)
                    $("#ClassCopy").checkbox("disable")
                    $("#page-class").waitMe("hide")
                }
            }
        })
        dgClass.datagrid("getPager").pagination({
            layout: ["list", "first", "prev", "next", "last", "info"]
        })
        ...
        $("#ClassGradeId").combogrid({
            ...
            onClickRow: function(index, row) {
                ...
                $("#ClassSchoolYearId").combobox("setValue", "").combobox("reload",
                    "{{ url('academic/school-year/combo-box') }}" + "/" + 1 + "?_token=" +
                    "{{ csrf_token() }}")
    ...
    function deleteGrade() {
        $.messager.confirm("Konfirmasi", "Anda akan menghapus data Tingkat terpilih, tetap lanjutkan?", function(r) {
            if (r) {
                destroyAcademicRef("tb-ref-grade", "{{ url('academic/grade/destroy') }}" + "/" + idGrade.value,
                    "grade")
            }
        })
    }
    ...
    function actionButtonGrade(viewType, idxArray) {
        for (var i = 0; i < menuActionGrade.length; i++) {
            if (viewType == "init") {
                $("#" + menuActionGrade[i].id).linkbutton({
                    disabled: false
                })
                if (i > 0) {
                    $("#" + menuActionGrade[i].id).linkbutton({
                ...
                for (var j = 0; j < idxArray.length; j++) {
                    $("#" + menuActionGrade[idxArray[j]].id).linkbutton({
                        disabled: true
                    })
                }
            }
    ...
    function deleteSchoolYear() {
        $.messager.confirm("Konfirmasi", "Anda akan menghapus data Tingkat terpilih, tetap lanjutkan?", function(r) {
            if (r) {
                destroyAcademicRef("tb-ref-schoolyear", "{{ url('academic/school-year/destroy') }}" + "/" +
                    idSchoolYear.value, "schoolyear")
            }
        })
    }
    ...
    function actionButtonSchoolYear(viewType, idxArray) {
        for (var i = 0; i < menuActionSchoolYear.length; i++) {
            if (viewType == "init") {
                $("#" + menuActionSchoolYear[i].id).linkbutton({
                    disabled: false
                })
                if (i > 0) {
                    $("#" + menuActionSchoolYear[i].id).linkbutton({
                ...
                for (var j = 0; j < idxArray.length; j++) {
                    $("#" + menuActionSchoolYear[idxArray[j]].id).linkbutton({
                        disabled: true
                    })
                }
            }
    ...
    function deleteSemester() {
        $.messager.confirm("Konfirmasi", "Anda akan menghapus data Semester terpilih, tetap lanjutkan?", function(r) {
            if (r) {
                destroyAcademicRef("tb-ref-semester", "{{ url('academic/semester/destroy') }}" + "/" +
                    idSemester.value, "semester")
            }
        })
    }
    ...
    function actionButtonSemester(viewType, idxArray) {
        for (var i = 0; i < menuActionSemester.length; i++) {
            if (viewType == "init") {
                $("#" + menuActionSemester[i].id).linkbutton({
                    disabled: false
                })
                if (i > 0) {
                    $("#" + menuActionSemester[i].id).linkbutton({
                ...
                for (var j = 0; j < idxArray.length; j++) {
                    $("#" + menuActionSemester[idxArray[j]].id).linkbutton({
                        disabled: true
                    })
                }
            }
    ...
    function deleteClass() {
        $.messager.confirm("Konfirmasi", "Anda akan menghapus data Kelas terpilih, tetap lanjutkan?", function(r) {
            if (r) {
                destroyAcademicRef("tb-ref-class", "{{ url('academic/class/destroy') }}" + "/" + idClass.value,
                    "class")
            }
        })
    }
    ...
    function actionButtonClass(viewType, idxArray) {
        for (var i = 0; i < menuActionClass.length; i++) {
            if (viewType == "init") {
                $("#" + menuActionClass[i].id).linkbutton({
                    disabled: false
                })
                if (i > 0) {
                    $("#" + menuActionClass[i].id).linkbutton({
                ...
                for (var j = 0; j < idxArray.length; j++) {
                    $("#" + menuActionClass[idxArray[j]].id).linkbutton({
                        disabled: true
                    })
                }
            }
    ...
    function exportAcademicRef(idGrid, route, document, title) {
        ...
        if (dg.total > 0) {
            exportDocument(route + document, dg.rows, "Ekspor data " + title + " ke " + document.toUpperCase(),
                "{{ csrf_token() }}")
        }
    }
